...
import { BrowsePublisher } from "../../../lib/browse-types";

type PublisherGameProp = {
  publisher: BrowsePublisher;
};

const PublishersGames = ({ publisher }: PublisherGameProp) => {
  const displayedGames = publisher.games.slice(0, 3);
